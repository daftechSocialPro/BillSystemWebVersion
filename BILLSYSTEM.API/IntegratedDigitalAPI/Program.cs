...
builder.Services.AddDbContext<DBGeneralContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("SqlConnectionGeneral")));


builder.Services.AddDbContext<DBCustomerContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("SqlConnectionCustomer")));


builder.Services.AddDbContext<DBHumanContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("SqlConnectionHuman")));
